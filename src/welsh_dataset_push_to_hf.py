...
LANGUAGE = "cy"
SPEAKER = "Mozilla"
REPO_ID = "ClemSummer/welsh-transcription-samples-7k"  # change to your username/repo name!
...
# ---------------------------
cv_mapped.save_to_disk("./my_welsh_dataset")
print("Saved locally to ./my_welsh_dataset")
